const diseases = [
  {
    name: "Argulus",
    description:
      "Argulus, a common fish parasite, causes Argulosis by attaching to the fish, resulting in symptoms like appetite loss and excess mucus. Control includes natural remedies like papaya seed extracts and chemical treatments like dimilin.",
    treatment:
  ...
  },
  {
    ...
    description:
      "Bacterial aeromoniasis is a disease caused by the bacterium Aeromonas hydrophila in fish.",
  ...
  },
  {
    name: "Bacterial Gill",
    description:
      "Bacterial gill disease (BGD) affects hatchery trout, causing gill filament clubbing. Environmental factors influence severity, impacting fish health by hindering respiration and balance. Similar issues can stem from diseases, toxins, or pollutants.",
  ...
  },
  {
    ...
    description:
      "Red spot disease in fish, caused by Pseudomonas anguilliseptica, leads to high mortality rates due to its rapid spread and detrimental effects on aquaculture.",
  ...
  },
  {
    ...
    description:
      "Epizootic Ulcerative Syndrome (EUS) is a fish disease caused by Aphanomyces invadans, marked by red spots evolving into ulcers due to fungal invasion of muscle tissue, leading to mycotic dermatitis granulomatosis.",
  ...
  },
  {
    ...
    description:
      "Saprolegniasis, caused by Saprolegnia spp., damages fish tissue and weakens immunity. Control involves using chitinolytic microorganisms like Bacillus licheniformis and Streptomyces olivaceoviridis.",
    treatment:
